//
//  AddCurrenciesCell.swift
//  Granthi
//
//  Created by Aayushma Rajkarnikar on 17/5/21.
//

import UIKit
class AddCurrenciesCell: UITableViewCell {
...
//        seperator color leko chaina
   ...
   fileprivate func setuplayout()  {
    ...
    container.anchor(top: nil, leading: selectionBtn.trailingAnchor, bottom: nil, trailing: nil, padding: .init(top: 0, left: 14, bottom: 0, right: 0), size: .init(width: 44, height: 44))
